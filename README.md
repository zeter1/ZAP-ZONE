...
В v21.7 проект получил расширенный визуальный проход: после оружия отдельные SVG-ассеты и более детальные 3D-представления появились у pickups, объектов арены и HUD.
