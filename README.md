...
- SR-9 использует мгновенный hitscan и отдельный 8× scope; штурмовая винтовка также получила собственный оптический ПКМ-прицел с умеренным увеличением для автоматического огня.
...
- `assets/ui/rifle-scope.svg` — отдельная оптика штурмовой винтовки;
