...
const WEAPONS=[
  weaponDef('pistol','ПИСТОЛЕТ','🔫',{clip:15,reload:1.25,rate:.22,dmg:26,spread:.012,adsSpread:.006,moveSpread:.010,airSpread:.035,falloffStart:20,falloffEnd:55,minDamageM:.62,bCol:0xffffaa,gCol:0xf5c800,brlCol:0xcccccc,pellets:1,recoilX:.016,recoilY:.032,recoilReturn:14,recoilDelay:.12,recoilPattern:[-.35,.18,-.12,.28],bloomPerShot:.0048,bloomMax:.024,bloomDecay:.060,firstShotM:.62,equipTime:.26,sprintRecover:.12,tacticalReloadM:.88,emptyReloadM:1.08,adsIn:.16,adsOut:.12,automatic:false,fireMode:'semi',zoomFov:52,startingAmmo:15,tracerColor:0xffd27a,muzzleVelocity:85,bulletGravity:4.8,range:55,viewPos:[.28,-.25,-.48],bot:{range:44,opt:20,hitBias:.90}}),
  weaponDef('shotgun','ДРОБОВИК','💥',{clip:6,reload:2.35,rate:.82,dmg:19,spread:.10,adsSpread:.075,moveSpread:.025,airSpread:.055,falloffStart:8,falloffEnd:24,minDamageM:.28,bCol:0xff8844,gCol:0x884422,brlCol:0x665533,pellets:8,recoilX:.045,recoilY:.085,recoilReturn:8.5,recoilDelay:.22,recoilPattern:[-.20,.18],bloomPerShot:.010,bloomMax:.030,bloomDecay:.050,firstShotM:.82,equipTime:.50,sprintRecover:.27,reloadStyle:'shell',shellStartM:.22,shellInsertM:.26,cycleTime:.62,adsIn:.22,adsOut:.16,automatic:false,fireMode:'pump',zoomFov:58,startingAmmo:6,tracerColor:0xffb06a,muzzleVelocity:68,bulletGravity:5.5,range:24,viewPos:[.30,-.27,-.54],bot:{range:20,opt:10,hitBias:.85}}),
  weaponDef('rifle','ШТУРМОВАЯ ВИНТОВКА','🎯',{clip:30,reload:2.15,rate:.10,dmg:31,spread:.008,adsSpread:.0035,moveSpread:.014,airSpread:.035,falloffStart:30,falloffEnd:75,minDamageM:.72,bCol:0x44ffaa,gCol:0x336644,brlCol:0x224433,pellets:1,recoilX:.011,recoilY:.026,recoilReturn:11,recoilDelay:.16,recoilPattern:[-.35,-.10,.16,.31,.08,-.22,.18,.35],bloomPerShot:.0032,bloomMax:.034,bloomDecay:.040,firstShotM:.54,equipTime:.40,sprintRecover:.20,tacticalReloadM:.90,emptyReloadM:1.12,adsIn:.19,adsOut:.13,automatic:true,fireMode:'auto',zoomFov:42,startingAmmo:30,tracerColor:0xffe0a0,muzzleVelocity:125,bulletGravity:3.2,range:75,viewPos:[.30,-.27,-.55],bot:{range:68,opt:36,hitBias:.94}}),
  weaponDef('rocket','РАКЕТНИЦА','🚀',{clip:1,reload:2.85,rate:1.10,dmg:155,spread:.006,adsSpread:.002,moveSpread:.012,airSpread:.025,bCol:0xff4400,gCol:0x553300,brlCol:0x442200,pellets:1,isRocket:true,recoilX:.05,recoilY:.105,recoilReturn:7.5,recoilDelay:.30,equipTime:.58,sprintRecover:.32,emptyReloadM:1.05,automatic:false,fireMode:'launcher',zoomFov:50,startingAmmo:1,viewPos:[.31,-.28,-.58],bot:{range:55,opt:30,hitBias:.88,dmg:140}}),
  weaponDef('plasma','ПЛАЗМА','⚡',{clip:40,reload:1.65,rate:.07,dmg:20,spread:.019,adsSpread:.010,moveSpread:.017,airSpread:.035,falloffStart:20,falloffEnd:58,minDamageM:.58,bCol:0xcc44ff,gCol:0x6622cc,brlCol:0x9944ff,pellets:1,recoilX:.009,recoilY:.015,recoilReturn:15,recoilDelay:.08,recoilPattern:[-.12,.08,-.06,.10],bloomPerShot:.0022,bloomMax:.025,bloomDecay:.060,firstShotM:.70,equipTime:.36,sprintRecover:.17,tacticalReloadM:.90,emptyReloadM:1.06,adsIn:.15,adsOut:.11,automatic:true,fireMode:'auto',zoomFov:46,startingAmmo:40,tracerColor:0xc47cff,muzzleVelocity:48,bulletGravity:0,range:58,viewPos:[.30,-.26,-.54],bot:{range:44,opt:23,hitBias:.89}}),
  weaponDef('mine','МИНА','💣',{clip:4,reload:3.2,rate:.90,dmg:130,spread:0,bCol:0xff8800,gCol:0x222222,brlCol:0x444444,pellets:1,isMine:true,recoilX:0,recoilY:0,equipTime:.30,sprintRecover:.10,automatic:false,fireMode:'deploy',startingAmmo:4,tracerColor:0xff8800,viewPos:[.29,-.27,-.52]}),
  weaponDef('bomb','БОМБА','🧨',{clip:2,reload:0,rate:1.2,dmg:240,spread:0,bCol:0xffcc22,gCol:0x551100,brlCol:0x111111,pellets:1,isBomb:true,recoilX:0,recoilY:0,equipTime:.34,sprintRecover:.14,automatic:false,fireMode:'deploy',startingAmmo:0,viewPos:[.29,-.27,-.52]}),
  weaponDef('smoke','ДЫМОВУХА','🌫️',{clip:1,reload:0,rate:.55,dmg:0,spread:0,bCol:0xc8d0d4,gCol:0x3f515a,brlCol:0x7d8b91,pellets:1,isSmoke:true,recoilX:.012,recoilY:.025,equipTime:.28,sprintRecover:.10,automatic:false,fireMode:'throw',startingAmmo:1,tracerColor:0xcbd4d8,viewPos:[.30,-.27,-.56]}),
  weaponDef('sniper','СНАЙПЕРСКАЯ ВИНТОВКА','🔭',{clip:5,reload:3.4,rate:1.30,dmg:118,spread:.040,adsSpread:.00045,moveSpread:.060,airSpread:.12,falloffStart:55,falloffEnd:110,minDamageM:.82,bCol:0x8fe8ff,gCol:0x17365b,brlCol:0xb8d5e8,pellets:1,isSniper:true,aimMode:'scope',hitscan:true,oneShot:true,headshotMult:2.55,recoilX:.028,recoilY:.115,recoilReturn:6.8,recoilDelay:.34,recoilPattern:[-.12,.10],bloomPerShot:.016,bloomMax:.020,bloomDecay:.028,firstShotM:.34,equipTime:.66,sprintRecover:.34,tacticalReloadM:.94,emptyReloadM:1.10,cycleTime:.92,adsIn:.34,adsOut:.20,automatic:false,fireMode:'bolt',zoomFov:12,startingAmmo:5,tracerColor:0xcff8ff,basePenetration:1,range:110,viewPos:[.31,-.29,-.62],bot:{range:108,opt:74,hitBias:.982}})
];
...
function makeBotWeaponMesh(key,team){
  const model=createWeaponModel(key,{mode:'bot',team,detail:MOBILE_LOW?0:1});model.scale.setScalar(.72);return model;
}
function refreshBotWeaponVisual(bot){
  if(!bot.weaponPivot)return;
  clearGroupChildren(bot.weaponPivot);
  const mesh=makeBotWeaponMesh(bot.weapon.key,bot.team);bot.weaponPivot.add(mesh);bot.weaponMesh=mesh;
}
...
function buildWeaponBar(){
  ...
  WEAPONS.forEach((w,i)=>{
    ...
    slot.className='wb-slot'+(i===curW?' active':'');
    slot.id='wb-'+i;
    slot.title=w.name;

    const asset=document.createElement('img');
    asset.className='wb-asset';
    asset.src=w.asset;
    asset.alt='';
    ...
    slot.append(asset,key,name);
    slot.addEventListener('click',()=>switchW(i));
...
function updateWeaponBar(){
  WEAPONS.forEach((_,i)=>{
    const el=G('wb-'+i);
    if(el){el.className='wb-slot'+(i===curW?' active':'');}
  });
}
