...
const WEAPONS=[
  weaponDef('pistol','ПИСТОЛЕТ','🔫',{clip:15,reload:1.25,rate:.22,dmg:26,spread:.012,adsSpread:.006,moveSpread:.010,airSpread:.035,falloffStart:20,falloffEnd:55,minDamageM:.62,bCol:0xffffaa,gCol:0xf5c800,brlCol:0xcccccc,pellets:1,recoilX:.016,recoilY:.032,recoilReturn:14,recoilDelay:.12,recoilPattern:[-.35,.18,-.12,.28],bloomPerShot:.0048,bloomMax:.024,bloomDecay:.060,adsIn:.16,adsOut:.12,automatic:false,fireMode:'semi',zoomFov:52,startingAmmo:15,tracerColor:0xffd27a,muzzleVelocity:85,bulletGravity:4.8,range:55,viewPos:[.28,-.25,-.48],bot:{range:44,opt:20,hitBias:.90}}),
  weaponDef('shotgun','ДРОБОВИК','💥',{clip:6,reload:2.35,rate:.82,dmg:19,spread:.10,adsSpread:.075,moveSpread:.025,airSpread:.055,falloffStart:8,falloffEnd:24,minDamageM:.28,bCol:0xff8844,gCol:0x884422,brlCol:0x665533,pellets:8,recoilX:.045,recoilY:.085,recoilReturn:8.5,recoilDelay:.22,recoilPattern:[-.20,.18],bloomPerShot:.010,bloomMax:.030,bloomDecay:.050,adsIn:.22,adsOut:.16,automatic:false,fireMode:'pump',zoomFov:58,startingAmmo:6,tracerColor:0xffb06a,muzzleVelocity:68,bulletGravity:5.5,range:24,viewPos:[.30,-.27,-.54],bot:{range:20,opt:10,hitBias:.85}}),
  weaponDef('rifle','ШТУРМОВАЯ ВИНТОВКА','🎯',{clip:30,reload:2.15,rate:.10,dmg:31,spread:.008,adsSpread:.0035,moveSpread:.014,airSpread:.035,falloffStart:30,falloffEnd:75,minDamageM:.72,bCol:0x44ffaa,gCol:0x336644,brlCol:0x224433,pellets:1,recoilX:.011,recoilY:.026,recoilReturn:11,recoilDelay:.16,recoilPattern:[-.35,-.10,.16,.31,.08,-.22,.18,.35],bloomPerShot:.0032,bloomMax:.034,bloomDecay:.040,adsIn:.19,adsOut:.13,automatic:true,fireMode:'auto',zoomFov:42,startingAmmo:30,tracerColor:0xffe0a0,muzzleVelocity:125,bulletGravity:3.2,range:75,viewPos:[.30,-.27,-.55],bot:{range:68,opt:36,hitBias:.94}}),
  ...
  weaponDef('plasma','ПЛАЗМА','⚡',{clip:40,reload:1.65,rate:.07,dmg:20,spread:.019,adsSpread:.010,moveSpread:.017,airSpread:.035,falloffStart:20,falloffEnd:58,minDamageM:.58,bCol:0xcc44ff,gCol:0x6622cc,brlCol:0x9944ff,pellets:1,recoilX:.009,recoilY:.015,recoilReturn:15,recoilDelay:.08,recoilPattern:[-.12,.08,-.06,.10],bloomPerShot:.0022,bloomMax:.025,bloomDecay:.060,adsIn:.15,adsOut:.11,automatic:true,fireMode:'auto',zoomFov:46,startingAmmo:40,tracerColor:0xc47cff,muzzleVelocity:48,bulletGravity:0,range:58,viewPos:[.30,-.26,-.54],bot:{range:44,opt:23,hitBias:.89}}),
  ...
  weaponDef('sniper','СНАЙПЕРСКАЯ ВИНТОВКА','🔭',{clip:5,reload:3.4,rate:1.30,dmg:118,spread:.040,adsSpread:.00045,moveSpread:.060,airSpread:.12,falloffStart:55,falloffEnd:110,minDamageM:.82,bCol:0x8fe8ff,gCol:0x17365b,brlCol:0xb8d5e8,pellets:1,isSniper:true,headshotMult:2.55,recoilX:.028,recoilY:.115,recoilReturn:6.8,recoilDelay:.34,recoilPattern:[-.12,.10],bloomPerShot:.016,bloomMax:.020,bloomDecay:.028,adsIn:.34,adsOut:.20,automatic:false,fireMode:'bolt',zoomFov:12,startingAmmo:5,tracerColor:0xcff8ff,muzzleVelocity:260,bulletGravity:2.2,basePenetration:1,range:110,viewPos:[.31,-.29,-.62],bot:{range:108,opt:74,hitBias:.982}})
];
